...
L["Show glow if current pull will spawn a Manifestation of Pride"] = "如果当前进度将产生傲慢, 则显示发光"
...
L["WarpDeplete will not show you Pride spawn alert or display the count for you current pull."] = "WarpDeplete 将不会显示傲慢警报或当前进度."
